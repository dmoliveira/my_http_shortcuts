...
export function renderHistoryStats(statsElement: HTMLElement, stats: HistoryStats): void {
  statsElement.textContent = `Total: ${stats.total} | OK: ${stats.ok} | ERR: ${stats.error} | success: ${stats.successRatePct}% | avg: ${stats.avgDurationMs}ms | max: ${stats.maxDurationMs}ms`;
}
